...
public class CrucioPickaxe extends ItemPickaxe
{
    public CrucioPickaxe(final int par1, final Item.ToolMaterial par2EnumToolMaterial) {
    ...
    public void addInformation(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final List par3List, final boolean par4) {
        if (ConfigMain.EXTRA_PICKAXE) {
            ...
            if (Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54)) {
                par3List.add(EnumChatFormatting.ITALIC + "- 4 Extra essence from Minicio Ores");
            }
        }
