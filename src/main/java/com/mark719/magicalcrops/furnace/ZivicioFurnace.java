...
public class ZivicioFurnace extends BlockContainer
{
    ...
    public ZivicioFurnace(final boolean isActive) {
        super(Material.rock);
    ...
    public void registerBlockIcons(final IIconRegister p_149651_1_) {
        this.blockIcon = p_149651_1_.registerIcon("magicalcrops:furnacezivicio_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.isBurning2 ? "magicalcrops:furnacezivicio_front_on" : "magicalcrops:furnacezivicio_front_off");
        this.field_149935_N = p_149651_1_.registerIcon("magicalcrops:furnacezivicio_top");
    }
    ...
    public boolean onBlockActivated(final World world, final int x, final int y, final int z, final EntityPlayer player, final int par6, final float par7, final float par8, final float par9) {
        player.openGui((Object)MagicalCrops.instance, 4, world, x, y, z);
        return true;
    }
    ...
    public static void updateBlockState(final boolean p_149931_0_, final World p_149931_1_, final int p_149931_2_, final int p_149931_3_, final int p_149931_4_) {
        ...
        ZivicioFurnace.isBurning = true;
        if (p_149931_0_) {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.ZivicioFurnaceActive);
        }
        else {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.ZivicioFurnace);
        }
        ZivicioFurnace.isBurning = false;
    ...
    public void breakBlock(final World world, final int x, final int y, final int z, final Block block, final int meta) {
        if (!ZivicioFurnace.isBurning) {
            final TileEntityZivicioFurnace tileentityZivicioFurnace = (TileEntityZivicioFurnace)world.getTileEntity(x, y, z);
            if (tileentityZivicioFurnace != null) {
                for (int i = 0; i < tileentityZivicioFurnace.getSizeInventory(); ++i) {
                    final ItemStack itemstack = tileentityZivicioFurnace.getStackInSlot(i);
                    if (itemstack != null) {
