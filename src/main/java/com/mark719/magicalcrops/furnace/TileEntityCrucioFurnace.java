...
public class TileEntityCrucioFurnace extends TileEntity implements ISidedInventory
{
    ...
    public TileEntityCrucioFurnace() {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceName : "Crucio Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag2 = true;
                CrucioFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
        if (flag2) {
            this.markDirty();
    ...
    public int[] getAccessibleSlotsFromSide(final int p_94128_1_) {
        return (p_94128_1_ == 0) ? TileEntityCrucioFurnace.slotsBottom : ((p_94128_1_ == 1) ? TileEntityCrucioFurnace.slotsTop : TileEntityCrucioFurnace.slotsSides);
    }
