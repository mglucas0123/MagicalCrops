...
public class AccioFurnace extends BlockContainer
{
    ...
    public AccioFurnace(final boolean isActive) {
        super(Material.rock);
    ...
    public void registerBlockIcons(final IIconRegister p_149651_1_) {
        this.blockIcon = p_149651_1_.registerIcon("magicalcrops:furnaceaccio_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.isBurning2 ? "magicalcrops:furnaceaccio_front_on" : "magicalcrops:furnaceaccio_front_off");
        this.field_149935_N = p_149651_1_.registerIcon("magicalcrops:furnaceaccio_top");
    }
    ...
    public boolean onBlockActivated(final World world, final int x, final int y, final int z, final EntityPlayer player, final int par6, final float par7, final float par8, final float par9) {
        player.openGui((Object)MagicalCrops.instance, 1, world, x, y, z);
        return true;
    }
    ...
    public static void updateBlockState(final boolean p_149931_0_, final World p_149931_1_, final int p_149931_2_, final int p_149931_3_, final int p_149931_4_) {
        ...
        AccioFurnace.isBurning = true;
        if (p_149931_0_) {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.AccioFurnaceActive);
        }
        else {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.AccioFurnace);
        }
        AccioFurnace.isBurning = false;
    ...
    public void breakBlock(final World world, final int x, final int y, final int z, final Block block, final int meta) {
        if (!AccioFurnace.isBurning) {
            final TileEntityAccioFurnace tileentityAccioFurnace = (TileEntityAccioFurnace)world.getTileEntity(x, y, z);
            if (tileentityAccioFurnace != null) {
                for (int i = 0; i < tileentityAccioFurnace.getSizeInventory(); ++i) {
                    final ItemStack itemstack = tileentityAccioFurnace.getStackInSlot(i);
                    if (itemstack != null) {
