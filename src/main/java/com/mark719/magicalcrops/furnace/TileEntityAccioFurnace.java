...
public class TileEntityAccioFurnace extends TileEntity implements ISidedInventory
{
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceName : "Accio Furnace";
    }
    ...
    public int[] getAccessibleSlotsFromSide(final int p_94128_1_) {
        return (p_94128_1_ == 0) ? TileEntityAccioFurnace.slotsBottom : ((p_94128_1_ == 1) ? TileEntityAccioFurnace.slotsTop : TileEntityAccioFurnace.slotsSides);
    }
