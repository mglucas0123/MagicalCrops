...
public class GuiAccioFurnace extends GuiContainer
{
    ...
    public GuiAccioFurnace(final InventoryPlayer invPlayer, final TileEntityAccioFurnace tile) {
        super((Container)new ContainerAccioFurnace(invPlayer, tile));
    ...
    protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
        ...
        this.fontRendererObj.drawString(string, 135 - this.fontRendererObj.getStringWidth(string), 6, 4210752);
        this.fontRendererObj.drawString(I18n.format("container.inventory", new Object[0]), 8, this.ySize - 94, 4210752);
    }
    
    protected void drawGuiContainerBackgroundLayer(final float var1, final int var2, final int var3) {
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        Minecraft.getMinecraft().renderEngine.bindTexture(GuiAccioFurnace.texture);
    ...
    static {
        texture = new ResourceLocation("magicalcrops".toLowerCase(), "textures/gui/accio_furnace_gui.png");
    }
}
