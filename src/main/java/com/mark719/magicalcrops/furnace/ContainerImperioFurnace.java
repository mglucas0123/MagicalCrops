...
public class ContainerImperioFurnace extends Container
{
    ...
    public ContainerImperioFurnace(final InventoryPlayer player, final TileEntityImperioFurnace tileEntityImperioFurnace) {
        this.tileImperioFurnace = tileEntityImperioFurnace;
        this.addSlotToContainer(new Slot((IInventory)tileEntityImperioFurnace, 0, 56, 17));
        this.addSlotToContainer(new Slot((IInventory)tileEntityImperioFurnace, 1, 56, 53));
        this.addSlotToContainer((Slot)new SlotFurnace(player.player, (IInventory)tileEntityImperioFurnace, 2, 116, 35));
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
    ...
    public void addCraftingToCrafters(final ICrafting craft) {
        ...
        craft.sendProgressBarUpdate((Container)this, 0, this.tileImperioFurnace.furnaceCookTime);
        craft.sendProgressBarUpdate((Container)this, 1, this.tileImperioFurnace.furnaceBurnTime);
        craft.sendProgressBarUpdate((Container)this, 2, this.tileImperioFurnace.currentBurnTime);
    }
    ...
    public void updateProgressBar(final int par1, final int par2) {
        if (par1 == 0) {
            this.tileImperioFurnace.furnaceCookTime = par2;
        }
        if (par1 == 1) {
            this.tileImperioFurnace.furnaceBurnTime = par2;
        }
        if (par1 == 2) {
            this.tileImperioFurnace.currentBurnTime = par2;
        }
    }
    ...
    public ItemStack transferStackInSlot(final EntityPlayer p_82846_1_, final int p_82846_2_) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (p_82846_2_ == 2) {
                ...
                else if (TileEntityImperioFurnace.isItemFuel(itemstack2)) {
