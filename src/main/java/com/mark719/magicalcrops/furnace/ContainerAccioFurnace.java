...
public class ContainerAccioFurnace extends Container
{
    ...
    public ContainerAccioFurnace(final InventoryPlayer player, final TileEntityAccioFurnace tileEntityAccioFurnace) {
        this.tileAccioFurnace = tileEntityAccioFurnace;
        this.addSlotToContainer(new Slot((IInventory)tileEntityAccioFurnace, 0, 56, 17));
        this.addSlotToContainer(new Slot((IInventory)tileEntityAccioFurnace, 1, 56, 53));
        this.addSlotToContainer((Slot)new SlotFurnace(player.player, (IInventory)tileEntityAccioFurnace, 2, 116, 35));
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
    ...
    public void addCraftingToCrafters(final ICrafting craft) {
        ...
        craft.sendProgressBarUpdate((Container)this, 0, this.tileAccioFurnace.furnaceCookTime);
        craft.sendProgressBarUpdate((Container)this, 1, this.tileAccioFurnace.furnaceBurnTime);
        craft.sendProgressBarUpdate((Container)this, 2, this.tileAccioFurnace.currentBurnTime);
    }
    ...
    public void updateProgressBar(final int par1, final int par2) {
        if (par1 == 0) {
            this.tileAccioFurnace.furnaceCookTime = par2;
        }
        if (par1 == 1) {
            this.tileAccioFurnace.furnaceBurnTime = par2;
        }
        if (par1 == 2) {
            this.tileAccioFurnace.currentBurnTime = par2;
        }
    }
    ...
    public ItemStack transferStackInSlot(final EntityPlayer p_82846_1_, final int p_82846_2_) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (p_82846_2_ == 2) {
                ...
                else if (TileEntityAccioFurnace.isItemFuel(itemstack2)) {
