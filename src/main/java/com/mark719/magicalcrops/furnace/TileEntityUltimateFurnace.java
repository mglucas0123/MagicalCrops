...
public class TileEntityUltimateFurnace extends TileEntity implements ISidedInventory
{
    ...
    public TileEntityUltimateFurnace() {
    ...
    public int getCookProgressScaled(final int par1) {
        return this.furnaceCookTime * par1 / 8;
    }
    ...
    public int[] getAccessibleSlotsFromSide(final int p_94128_1_) {
        return (p_94128_1_ == 0) ? TileEntityUltimateFurnace.slotsBottom : ((p_94128_1_ == 1) ? TileEntityUltimateFurnace.slotsTop : TileEntityUltimateFurnace.slotsSides);
    }
