...
public class BlockFarmlandImperio extends Block
{
    ...
    public void registerBlockIcons(final IIconRegister p_149651_1_) {
        this.field_149824_a = p_149651_1_.registerIcon(this.getTextureName() + "wet_imperio");
        this.field_149823_b = p_149651_1_.registerIcon(this.getTextureName() + "dry_imperio");
    }
}
