...
public class ItemBlockEssenceBrick2 extends ItemBlock
{
    private static final String[] SUBNAMES;
    
    public ItemBlockEssenceBrick2(final Block block) {
        super(block);
    ...
    public String getUnlocalizedName(final ItemStack par1ItemStack) {
        ...
        return super.getUnlocalizedName() + "." + ItemBlockEssenceBrick2.SUBNAMES[i];
    }
