...
public class ItemBlockEssenceLamp extends ItemBlock
{
    private static final String[] SUBNAMES;
    
    public ItemBlockEssenceLamp(final Block block) {
        super(block);
    ...
    public String getUnlocalizedName(final ItemStack par1ItemStack) {
        ...
        return super.getUnlocalizedName() + "." + ItemBlockEssenceLamp.SUBNAMES[i];
    }
